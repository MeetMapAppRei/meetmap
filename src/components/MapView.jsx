    ...
    >
      ...
      {!mapLoaded && (
        ...
        >
          ...
          <div style={{ fontFamily: "'DM Sans', sans-serif", color: '#555', fontSize: 13 }}>
            Loading map...
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Add your free Mapbox token in{' '}
          <code style={{ color: '#FF6B35' }}>src/components/MapView.jsx</code> to enable the live
          map. See SETUP-GUIDE.md.
        </div>
      </div>
