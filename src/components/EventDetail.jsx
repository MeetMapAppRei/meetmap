...
import { fetchComments, postComment, toggleAttendance, getAttendanceStatus } from '../lib/supabase'
...
export default function EventDetail({ event, onClose, onAuthNeeded }) {
  const { user } = useAuth()
          ...
          <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
            {!isPast && (
              <button
                ...
                style={{
                  flex: 2, background: attending ? 'transparent' : color,
                  color: attending ? color : '#0A0A0A',
                  border: `1px solid ${color}`, borderRadius: 10, padding: '12px',
            ...
            <button
              onClick={handleShare}
              style={{
                flex: 1, background: '#141414', color: copied ? '#7CFF6B' : '#888',
                border: '1px solid #222', borderRadius: 10, padding: '12px',
          ...
          {comments.map(c => (
            <div key={c.id} style={{ marginBottom: 14 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 600, color: '#aaa' }}>
              ...
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: '#888', paddingLeft: 36, lineHeight: 1.5 }}>
                {c.text}
              </div>
            </div>
          ))}
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8, padding: '0 16px', fontFamily: "'Bebas Neue', sans-serif",
